...
require(lhs)
pdf("Figure/value_uncertainty_v2.pdf", width =2*3.94, height =3*2.43)




par(cex=0.5,fig=c(0,0.5,.66,1))
...
ss=0.04
#par(mai=c(.4,.4,.4,.4))
par(cex=0.5,fig=c(0,0.5,0.33+ss,.66+ss),new=T)
...
par(fig=c(0.5,1,.33+ss,0.66+ss),new=T)
# Establish the damage-depth relationship 
EU_Depth <-           c(0, 1.64, 3.28, 4.92, 6.56, 9.84, 13.12, 16.40)
...
par(fig=c(0.25,0.75,0,.33),new=T)
...
text(-0.03,1.07,'a)',bty="n",xpd=T,cex=2)
text(-0.03,.7,'b)',bty="n",xpd=T,cex=2)
text(0.55,.7,'c)',bty="n",xpd=T,cex=2)
text(0.26,0.24,'d)',bty="n",xpd=T,cex=2)
