...
load(paste(main_path,"Source_Code/Results_RData/GEV/GEV_Parameter_Chains.RData",sep=""))
source(paste(main_path,"Source_Code/I_not_Sure/mycolors.R",sep=""))
...
expected_damages <- function(Struc_Value,House_Initial_Stage,
  ...
  plot(Critical_Probs,damage_vals,type="l")
