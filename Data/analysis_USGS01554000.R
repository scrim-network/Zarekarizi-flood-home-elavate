...
setwd("~/Documents/Research/House_Elevation_Project")

# Read the file downloaded from USGS
x=read.table("nwis.waterdata.usgs.gov.txt",header = F,sep="\t",skip=34,colClasses=c("NULL","NULL","character","NULL","integer","NULL"),col.names=c("","","Time","","Qcfs",""))
